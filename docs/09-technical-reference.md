...
| --- | --- |
| Product | ZipLink |
| Document | Technical Reference and Operations Guide |
| Related documents | [`../README.md`](../README.md) (start there for the project overview), [PRD](01-prd.md), [Technical specification](02-technical-specification.md), [App flow](03-app-flow.md), [Design specification](04-design-specification.md), [Database schema](05-database-schema.md), [Implementation plan](06-implementation-plan.md), [Agent to-do tracker](07-agent-todo-tracker.md), [Project rules](08-project-rules.md) |

This is the detailed setup, API, and operations reference for developers running or
extending ZipLink — full local setup steps, the complete API surface, security/privacy
behavior, backup/retention procedure, and the full redirect-performance benchmark tables.
For what the project is and what it achieves, see [the main README](../README.md).
...
![Dashboard home, showing the create-link form and three sample links](screenshots/dashboard-home.png)

A link's detail page — total clicks, a live chart, and referrer/device/browser/geography
breakdowns:

![Link detail and analytics page, showing a clicks-over-time chart and breakdown cards](screenshots/link-detail-analytics.png)
...
[the implementation plan](06-implementation-plan.md): Phases 0–7 are complete — the
...
`06-implementation-plan.md` Section 10.3's rollout policy for rollups is explicit:
...
documented in the [database schema](05-database-schema.md) but not yet implemented
...
The intended shape, per `05-database-schema.md`, is a scheduled job that drops
...
real production traffic — see `02-technical-specification.md` Section 9.5 for the
...
Per `06-implementation-plan.md` Section 20, checked only once genuinely verified —
not assumed:
...
- [x] Dashboard implements the approved design and accessibility requirements — see
      `04-design-specification.md`'s Section 18 acceptance checklist and the
